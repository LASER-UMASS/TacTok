...
function split_unk_thresh {
  ...
  python ../split_unk.py constructors.pickle --threshold $1
  ...
  mv constructors-known.pickle constructors-known-$1.pickle
  mv constructors-unknown.pickle constructors-unknown-$1.pickle
